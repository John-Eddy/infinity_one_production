...
function modules() {
  ...
  // Bootstrap JS
  var bootstrapValidator = gulp.src('./node_modules/bootstrap-validator/dist/**/*')
    .pipe(gulp.dest('./js/vendor/bootstrap-validator/'));
  // Font Awesome CSS
  ...
  return merge(bootstrap, bootstrapValidator, fontAwesomeCSS, fontAwesomeWebfonts, jquery, jqueryEasing, magnificPopup);
}
